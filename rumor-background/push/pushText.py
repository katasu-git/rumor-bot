...
line_bot_api.push_message("Uf811de50a7725a63c181cf7fc8977ae7", messages=[flex_message,message]) #id指定して個人に送信するパターン
#l ine_bot_api.multicast(['to1', 'to2'], messages) #複数ユーザに送信するには配列でidを渡す
